...
import { HeroProps,BuyProps } from '~/shared/types';
...
export const buyPricing: BuyProps = {
  title: 'Plans and Pricesdddd',
  subtitle: (
    <>
      <span className="hidden md:inline">
        {`Here, you'll find a clear breakdown of our service plans and their respective features. Whether you're a small
      ...
      You can choose the plan that best suits your goals!fffff
    </>
  ),
  tagline: 'Demo Pricing Page',
};
